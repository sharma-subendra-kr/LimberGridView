...
var main = function(){
	...
	var $toggleModeButton = document.getElementsByClassName("toggleAddOrCutSpaceButton");
	...
	var onToggleModeClick = function(event){
		...
		if(event.currentTarget.classList.contains("activateAddMode")){
			...
			event.currentTarget.parentNode.childNodes[0].classList.add("toggleAddOrCutSpaceButtonActive");
			window.limberGridView.setAddOrCutSpace("ADD");
		}else if(event.currentTarget.classList.contains("activateCutSpaceMode")){
			event.currentTarget.classList.remove("toggleAddOrCutSpaceButtonActive");
			event.currentTarget.parentNode.childNodes[1].classList.add("toggleAddOrCutSpaceButtonActive");
	...
	var layoutHtml = "<div class = \"itemLayout\"><span>Title</span><div class = \"itemDropDownButton\">:::<div class = \"itemDropDown\"><div class = \"itemDropDownItem\">add</div><div class = \"itemDropDownItem\">remove</div></div></div></div>";
	...
	var piechart = function(width, height){
		...
		var gForMargin = svg.append("g")
    		.attr("transform", "translate(" + margin.left + "," + margin.top + ")")
    		.attr("width", chartWidth)
			.attr("height", chartHeight)
		;

		var g = gForMargin.append("g")
	...
	var barchart = function(width, height){
		var data = [{"label" : "A", "value" : 10}, {"label" : "B", "value" : 5}, {"label" : "C", "value" : 10}, {"label" : "D", "value" : 20}, {"label" : "E", "value"  : 10}, {"label" : "F", "value"  : 5}, {"label" : "G", "value"  : 20}, {"label" : "H", "value"  : 7}, {"label" : "I", "value"  : 3}, {"label" : "J", "value"  : 10}];
	...
	function getItemRenderDataCallback(index, width, height, processType){
		...
		if(processType == "render" || processType == "onDemand" || processType == "removeItems" || processType == "resizeItems"){
			if(charts[index] == 0){
		...
		}else if(processType == "addItems" || processType == "addItemInteractive"){
			if(index % 2 == 0){
				charts.push(0);
			}else if(index % 3 == 0){
				charts.push(2);
	...
	var obj = {
		...
		initialGridData : {"gridHeight":482,"gridWidth":999,"margin":3.830521472392638,"initialPositionData":[{"x":0,"y":0,"height":371.56058282208585,"width":506.3949386503067},{"x":512.1776649746192,"y":0,"height":202.84263959390861,"width":202.84263959390861},{"x":512.1776649746192,"y":207.91370558375635,"height":163.64677223926378,"width":199.53339570552146},{"x":720.0913705583756,"y":0,"height":374.625,"width":268.18323542944785},{"x":0,"y":383.17659057643795,"height":202.84263959390861,"width":202.84263959390861},{"x":207.91370558375635,"y":383.17659057643795,"height":202.84263959390861,"width":202.84263959390861},{"x":415.8274111675127,"y":383.17659057643795,"height":202.84263959390861,"width":578.1015228426396},{"x":0,"y":591.0902961601943,"height":608.5279187817258,"width":405.68527918781723},{"x":414.4624233128834,"y":594.4969325153374,"height":486.2310736196319,"width":552.2370874233128},{"x":0,"y":1208.197027498365,"height":438.1580291411043,"width":718.6058282208588}]},
	...
	console.log(window.getComputedStyle(body[0], null).getPropertyValue("width"));
