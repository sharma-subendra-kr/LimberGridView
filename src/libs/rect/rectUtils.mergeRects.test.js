...
describe("mergeRects reverse", () => {
	...
	test("right  overlapping", () => {
		let rectA = { x1: 2, y1: 2, x2: 6, y2: 6 };
		let rectB = { x1: 0, y1: 5, x2: 3, y2: 6 };
		let res = [{ x1: 0, y1: 5, x2: 6, y2: 6 }];
		expect(mergeRects(rectA, rectB)).toStrictEqual(res);

		rectA = { x1: 2, y1: 2, x2: 6, y2: 6 };
		rectB = { x1: 0, y1: 2, x2: 3, y2: 6 };
		res = [{ x1: 0, y1: 2, x2: 6, y2: 6 }];
		expect(mergeRects(rectA, rectB)).toStrictEqual(res);

		rectA = { x1: 2, y1: 2, x2: 6, y2: 6 };
		rectB = { x1: 0, y1: 1, x2: 3, y2: 6 };
		res = [{ x1: 0, y1: 2, x2: 6, y2: 6 }];
		expect(mergeRects(rectA, rectB)).toStrictEqual(res);

		rectA = { x1: 2, y1: 2, x2: 6, y2: 6 };
		rectB = { x1: 0, y1: 3, x2: 3, y2: 4 };
		res = [{ x1: 0, y1: 3, x2: 6, y2: 4 }];
		expect(mergeRects(rectA, rectB)).toStrictEqual(res);

		rectA = { x1: 2, y1: 2, x2: 6, y2: 6 };
		rectB = { x1: 0, y1: 2, x2: 3, y2: 4 };
		res = [{ x1: 0, y1: 2, x2: 6, y2: 4 }];
		expect(mergeRects(rectA, rectB)).toStrictEqual(res);

		rectA = { x1: 2, y1: 2, x2: 6, y2: 6 };
		rectB = { x1: 0, y1: 1, x2: 3, y2: 4 };
		res = [
			{ x1: 0, y1: 2, x2: 6, y2: 4 },
			{ x1: 2, y1: 1, x2: 3, y2: 6 },
		];
	...
	test("right above  overlapping", () => {
		...
		rectA = { x1: 2, y1: 2, x2: 6, y2: 6 };
		rectB = { x1: 0, y1: 2, x2: 3, y2: 7 };
		res = [{ x1: 0, y1: 2, x2: 6, y2: 6 }];
		expect(mergeRects(rectA, rectB)).toStrictEqual(res);

		rectA = { x1: 2, y1: 2, x2: 6, y2: 6 };
		rectB = { x1: 0, y1: 1, x2: 3, y2: 7 };
		res = [{ x1: 0, y1: 2, x2: 6, y2: 6 }];
		expect(mergeRects(rectA, rectB)).toStrictEqual(res);
	});
	...
	test("top  overlapping", () => {
		let rectA = { x1: 2, y1: 2, x2: 6, y2: 6 };
		let rectB = { x1: 2, y1: 5, x2: 3, y2: 7 };
		let res = [{ x1: 2, y1: 2, x2: 3, y2: 7 }];
		expect(mergeRects(rectA, rectB)).toStrictEqual(res);

		rectA = { x1: 2, y1: 2, x2: 6, y2: 6 };
		rectB = { x1: 2, y1: 5, x2: 6, y2: 7 };
		res = [{ x1: 2, y1: 2, x2: 6, y2: 7 }];
		expect(mergeRects(rectA, rectB)).toStrictEqual(res);

		rectA = { x1: 2, y1: 2, x2: 6, y2: 6 };
		rectB = { x1: 2, y1: 5, x2: 8, y2: 7 };
		res = [{ x1: 2, y1: 2, x2: 6, y2: 7 }];
		expect(mergeRects(rectA, rectB)).toStrictEqual(res);

		rectA = { x1: 2, y1: 2, x2: 6, y2: 6 };
		rectB = { x1: 3, y1: 5, x2: 4, y2: 7 };
		res = [{ x1: 3, y1: 2, x2: 4, y2: 7 }];
		expect(mergeRects(rectA, rectB)).toStrictEqual(res);

		rectA = { x1: 2, y1: 2, x2: 6, y2: 6 };
		rectB = { x1: 3, y1: 5, x2: 6, y2: 7 };
		res = [{ x1: 3, y1: 2, x2: 6, y2: 7 }];
		expect(mergeRects(rectA, rectB)).toStrictEqual(res);
	...
	test("top left overlapping", () => {
		...
		rectA = { x1: 2, y1: 2, x2: 6, y2: 6 };
		rectB = { x1: 0, y1: 5, x2: 6, y2: 7 };
		res = [{ x1: 2, y1: 2, x2: 6, y2: 7 }];
		expect(mergeRects(rectA, rectB)).toStrictEqual(res);

		rectA = { x1: 2, y1: 2, x2: 6, y2: 6 };
		rectB = { x1: 0, y1: 5, x2: 7, y2: 7 };
		res = [{ x1: 2, y1: 2, x2: 6, y2: 7 }];
		expect(mergeRects(rectA, rectB)).toStrictEqual(res);
	});
});
